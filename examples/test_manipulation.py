...
class TestClass:
    ...
    @pytest.mark.railflow(author='Alice', description='Division of two numbers',
                jira_id=100334, test_path='test_manipulation.py', 
                case_fields="fieldZ1", result_fields="fieldZ2",
                id_mappings="map id2", case_type="test case", case_priority="important")
